...
- (void)applicationWithDidReceive:(UILocalNotification * _Nonnull)notification;
- (void)handleActionWithIdentifier:(NSString * _Nonnull)identifier forRemoteNotification:(NSDictionary * _Nonnull)notification;
- (void)handleActionWithIdentifier:(NSString * _Nonnull)identifier forLocalNotification:(UILocalNotification * _Nonnull)notification;
@end
