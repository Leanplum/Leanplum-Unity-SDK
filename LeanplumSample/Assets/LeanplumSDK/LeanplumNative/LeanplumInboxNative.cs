    ...
    public class LeanplumInboxNative : LeanplumInbox
    {
        ...
        internal void Save()
        {
            ...
            foreach (var msg in _messages)
            {
                ...
                msgData[Constants.Keys.DELIVERY_TIMESTAMP] = msg.DeliveryTimestamp;
                msgData[Constants.Keys.EXPIRATION_TIMESTAMP] = msg.ExpirationTimestamp;
        ...
        internal void Load()
        {
            ...
            if (json != null)
            {
                var msgs = MiniJSON.Json.Deserialize(json) as List<IDictionary<string, object>>;
